			...
			<div class="top-area">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							<p class="bold text-center"><small class="text-muted"><?php echo gethostname(); ?></small></p>
						</div>
						<div class="col-sm-4 col-md-4">
								...
								<li class="cbp-item psychiatrist">
									<a href="doctors/member1.html" class="cbp-caption cbp-singlePage">
										<div class="cbp-caption-defaultWrap">
											<img src="img/team/alfred.png" alt="" width="100%">
										</div>
									...
									<a href="doctors/member1.html" class="cbp-singlePage cbp-l-grid-team-name">Dr. Alfred Bach</a>
									<div class="cbp-l-grid-team-position">Psychiatrist</div>
								</li>
								<li class="cbp-item cardiologist">
									<a href="doctors/member2.html" class="cbp-caption cbp-singlePage">
										<div class="cbp-caption-defaultWrap">
											<img src="img/team/wanja.png" alt="" width="100%">
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
									...
									<a href="doctors/member2.html" class="cbp-singlePage cbp-l-grid-team-name">Dr. Wanja Pernath</a>
									<div class="cbp-l-grid-team-position">Cardiologist</div>
								</li>
								<li class="cbp-item cardiologist">
									<a href="doctors/member3.html" class="cbp-caption cbp-singlePage">
										<div class="cbp-caption-defaultWrap">
											<img src="img/team/pille.jpg" alt="" width="100%">
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
									...
									<a href="doctors/member3.html" class="cbp-singlePage cbp-l-grid-team-name">Dr. Leonard McCoy</a>
									<div class="cbp-l-grid-team-position">Cardiologist</div>
								</li>
								<li class="cbp-item neurologist">
									<a href="doctors/member4.html" class="cbp-caption cbp-singlePage">
										<div class="cbp-caption-defaultWrap">
											<img src="img/team/frankenstein.jpg" alt="" width="100%">
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
									...
									<a href="doctors/member4.html" class="cbp-singlePage cbp-l-grid-team-name">Dr. Frankenstein</a>
